...
// Why we need astronomical date for gff3 ?
const Astronomical = "2006-01-02"

// Why we need this type separately ?
// Also having the identical type name and method is a little bit confusing ?
type Error string

// Why the receiver is not pass as a pointer ?
...
// meaning of this construct, check here
// http://play.golang.org/p/wBnz8_vj-N
const (
	nameField = iota
	sourceField
	featureField
...
// Once again why no pointer ?
func (f Frame) String() string {
	if f <= NoFrame || f > Frame2 {
		return "."
	}
	// Don't understand the construct here
	return [...]string{"0", "1", "2"}[f]
}

// check here http://play.golang.org/p/dD3EQHG7fZ
const (
